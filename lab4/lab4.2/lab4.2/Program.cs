...
namespace lab4._2
{
    class Program
    {
        [DllImport("C:\\Users\\User\\Desktop\\ISP\\lab4\\DLLlab4\\Debug\\Dlllab4.dll", CallingConvention = CallingConvention.StdCall)]
        static extern float Min(float a, float b);
        [DllImport("C:\\Users\\User\\Desktop\\ISP\\lab4\\DLLlab4\\Debug\\Dlllab4.dll", CallingConvention = CallingConvention.StdCall)]
        static extern float Max(float a, float b);
        [DllImport("C:\\Users\\User\\Desktop\\ISP\\lab4\\DLLlab4\\Debug\\Dlllab4.dll", CallingConvention = CallingConvention.StdCall)]
        static extern float Abs(float a);
        [DllImport("C:\\Users\\User\\Desktop\\ISP\\lab4\\DLLlab4\\Debug\\Dlllab4.dll", CallingConvention = CallingConvention.Cdecl)]
        static extern float Pow(float a, int b);
        [DllImport("C:\\Users\\User\\Desktop\\ISP\\lab4\\DLLlab4\\Debug\\Dlllab4.dll", CallingConvention = CallingConvention.Cdecl)]
        static extern int Fact(int a);
        [DllImport("C:\\Users\\User\\Desktop\\ISP\\lab4\\DLLlab4\\Debug\\Dlllab4.dll", CallingConvention = CallingConvention.Cdecl)]
        static extern ulong Fibonacci(int a);
