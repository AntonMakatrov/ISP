...
namespace Cars
{
    ...
    sealed class McLaren : Car
    {
        ...
        public McLaren(string CarModel, int Weight, int PassengerSeats, int TankCapacity, double FuelFlow, int MaxSpeed, int HorsePower) :
            base(Weight, PassengerSeats, TankCapacity, FuelFlow, MaxSpeed, HorsePower)
        {
            Brand = "McLaren";
            Model = CarModel;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cars [2] = new McLaren("720s", 1350, 2, 80, 12, 340, 720);
